...
public class exercicio3 {
	...
	String L [][] = fazerprova (nalunos);
	int T [] = respostacerta (nalunos, L);
	aprovação (nalunos, T);}
	
	public static String [][] fazerprova (int nalunos) {
	...
	public static int [] respostacerta (int nalunos, String L [][]){
		Scanner teclado = new Scanner(System.in);
		String resposta [][] = L;
	...
	public static void aprovação (int nalunos, int T []) {
	int certo[] = T;
		for(int i=0; i< nalunos; i++) {
		 if(certo[i] >= 7) {
